import {
  ...
  export function ModelCard({model}:{model:any}) {
    return (
      ...
      <Card className="w-full col-span-1 drop-shadow bg-[#f9f9f999] hover:bg-[#ece9fd9f] cursor-pointer transition-all duration-500"  placeholder={undefined}>
        ...
        <CardBody  placeholder={undefined}>
          ...
          <Typography color="gray"  placeholder={undefined}>
            {
              (model.description as string).substring(0,200)
            }
          </Typography>
          <div className="flex w-full justify-around items-center place-items-stretch">
            <div className="group mt-8 inline-flex flex-wrap items-center gap-3">
                
              
                
            <Button size="sm" className="h-full bg-yellow-800" placeholder={undefined}>see more</Button>
